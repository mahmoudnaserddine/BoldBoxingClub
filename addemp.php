...
<h2 style="font-style:bold; text-align:center;">Add Schedules</h2>
<form method="post" style="text-align:center;" action="addempaction.php"> 
...
Full Name:
      ...
      Experience:
        <center> <input type="text" id="experience" name="experience" required></center>
