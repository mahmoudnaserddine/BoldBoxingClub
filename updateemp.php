...
<?php 
  ...
  $sql="update employees set fullname='".$_POST["fullname"]."',date_of_birth='".$_POST["date_of_birth"]."',phone_number='".$_POST["phone_number"]."',experience='".$_POST["experience"]."'  where employee_id=".$_POST["id"];
  echo $sql;
